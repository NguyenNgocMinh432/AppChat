...
public class  MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MessageAdapter.ViewHolder holder, int position) {
        ...
        holder.messageLayout.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                builder.setMessage("Bạn có chắc chắn xóa tin nhắn này không? ");
    ...
    private void deleteMessage(int position) {
        ...
        Query query = ddRef.orderByChild("messageId").equalTo(messageId);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()){
                    if (ds.child("sender").getValue().equals(myUID)){
                        ...
                        Toast.makeText(mContext, "Bạn chỉ có thể xóa tin nhắn của mình!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
